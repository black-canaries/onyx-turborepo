...
export default function App() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      <ScrollView className="p-6 gap-8">
        <View className="gap-3">
          <Text className="text-indigo-500 font-semibold uppercase tracking-wide text-xs">
            Multiplatform app
          </Text>
          <Text className="text-foreground text-3xl font-bold leading-tight">
        ...
        <View className="bg-card rounded-2xl p-5 gap-3 border border-border">
        ...
        <View className="gap-4">
          <Text className="text-foreground text-xl font-semibold">Features</Text>
          <View className="gap-4">
            {features.map((feature) => (
              <View key={feature.title} className="bg-card rounded-2xl p-5 gap-2 border border-border">
                <Text className="text-card-foreground text-base font-semibold">{feature.title}</Text>
                <Text className="text-muted-foreground text-sm leading-5">{feature.description}</Text>
              </View>
            ))}
          </View>
        </View>
        ...
        <View className="gap-4">
          <Text className="text-foreground text-xl font-semibold">Backend connections</Text>
          <Text className="text-muted-foreground text-sm leading-5">
  ...
  return (
    <View className="bg-card rounded-2xl p-5 gap-3 border border-border">
      <View className="flex-row justify-between items-center gap-3 mb-1">
        <Text className="text-card-foreground text-base font-semibold flex-1">{title}</Text>
        <View className={`px-2 py-1 rounded-md ${configured ? "bg-muted" : "bg-destructive/20"}`}>
      ...
      <View className="flex-row justify-between items-center gap-3 mt-1">
        <Text className="text-muted-foreground text-sm leading-5 flex-1">
          {configured
